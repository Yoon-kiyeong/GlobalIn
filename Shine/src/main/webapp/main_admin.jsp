...
<body>
	<div>
		<div class="MainContainer main1">
			...
			<div class="wrapper vacation" onclick="clickDayoff()">
				<br>
				<b>총 연차 : &nbsp;&nbsp;&nbsp;&nbsp; <span>00</span> <br>
				<br>
				<br> 잔여 연차 : &nbsp;&nbsp;<span>00</span></b>
			</div>
		</div>
		...
		<div class="MainContainer main3">
			<div class="wrapper link" onclick="clickJoin()">
				<br>
				<b>사원등록</b>
			</div>

			<div class="wrapper link2" onclick="clickUpdate()">
				<br>
				<b>회원정보 수정</b>
			</div>
			<div class="wrapper link3" onclick="clickVacation()">
				<br>
				<b>연차현황</b>
			</div>
		</div>
	...
	<script type="text/javascript">
		...
		function clickUpdate() {
			window.location.href = "mypage_admin.jsp";
		}

		function clickVacation() {
			window.location.href = "dayoff_admin.jsp";
		}
	</script>
